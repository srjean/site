...
function NameStateChanged()
{
                if (nameHttp.readyState==4)
                {
                        ...
                        if($_POST['savecharacter'] != 1)
                        {
                                ...
                                if(count($config['site']['newchar_vocations'][$world_id]) > 0)
                                ...
                                if(count($config['site']['newchar_towns'][$world_id]) > 0 || count($config['site']['newchar_vocations'][$world_id]) > 0)
                                ...
                                if(count($config['site']['newchar_towns'][$world_id]) > 0)
                                {
                                ...
                                if(count($config['site']['newchar_towns'][$world_id]) > 1 || count($config['site']['newchar_vocations'][$world_id]) > 0)
